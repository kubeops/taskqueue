...
// OpsV1alpha1Client is used to interact with features provided by the ops.k8s.appscode.com group.
type OpsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OpsV1alpha1Client) PendingTasks() PendingTaskInterface {
	return newPendingTasks(c)
}
